package game.tests; //Change me


/**
 * Project imports
 */
import game.controller.Controller; //Change me
import game.view.GamePanel; //Change me
import javax.swing.*;
...
class TestGamePanel
{
	...
	void testPanelComponents()
	{
		...
		assertTrue(fields.length > 2, "You need at least 3 data members in your GamePanel");
